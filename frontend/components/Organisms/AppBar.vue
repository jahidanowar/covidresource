    ...
    >
      <div class="container mx-auto flex justify-between items-center">
        ...
        <ul class="w-full sm:w-auto inline-flex justify-around">
          <li class="p-5">
            <menu-item to="/" :title="$t('appbar.home')">
          ...
          <li class="p-5">
            <menu-item to="/resources" :title="$t('appbar.tiles')">
              <template v-if="$route.path == '/resources'">
                <svg
                  class="w-6 h-6"
                  fill="currentColor"
                  viewBox="0 0 20 20"
          ...
          <client-only>
            <li v-if="$store.state.auth.loggedIn" class="p-5">
              <menu-item to="/user/dashboard" :title="$t('appbar.dashboard')">
                <template v-if="$route.path == '/user/dashboard'">
                  <svg
                    class="w-6 h-6"
                    fill="currentColor"
                    viewBox="0 0 20 20"
            ...
            <li v-if="!$store.state.auth.loggedIn" class="p-5">
              <menu-item to="/user/auth/login" :title="$t('appbar.login')">
                <template v-if="$route.path == '/user/auth/login'">
                  <svg
                    class="w-6 h-6"
                    fill="currentColor"
                    viewBox="0 0 20 20"
            ...
            >
              <menu-item to="/user/dashboard/users" title="Manage Users">
                <template v-if="$route.path == '/user/dashboard/users'">
                  <svg
                    class="w-6 h-6"
                    fill="currentColor"
                    viewBox="0 0 20 20"
